document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        const validateField = function(input) {
            ...
            if (value && input.hasAttribute('maxlength')) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                // Simulate async submission - replace with actual fetch call
                setTimeout(function() {
                    if (submitButton) {
                    ...
                    successMessage.style.cssText = 'color: #27ae60; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background: #d5f5e3; border-radius: 4px;';
        ...
        contactForm.addEventListener('blur', function(e) {
            ...
            if (input.matches('input, textarea, select') && input.name) {
                if (input.value.trim()) {
                    validateField(input);
                } else {
                    clearError(input);
        ...
        contactForm.addEventListener('input', function(e) {
            const input = e.target;
            if (input.matches('input, textarea') && input.name) {
                clearError(input);
            }
        });
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a0509c96-7fd3-47c4-baec-452e1fd94ac0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a0509c96-7fd3-47c4-baec-452e1fd94ac0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a0509c96-7fd3-47c4-baec-452e1fd94ac0';
